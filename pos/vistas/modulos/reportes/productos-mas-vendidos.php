...
$productosagotado = ControladorProductos::ctrMostrarProductosAgotados();
 ?>
<!--=====================================
...
<div class="box box-primary">
  ...
  <div class="box-header with-border">
    ...
    <h3 class="box-title">PRODUCTOS POR AGOTARSE</h3>
  ...
  <div class="box-body">
    ...
    foreach ($productosagotado as $key => $val) {
      ...
      echo '<li class="item">
        ...
        <div class="product-info">
          ...
          <a href="" class="product-title">
            ...
            <span class="label label-warning pull-right">quedan'.$val["stock"].'</span>
