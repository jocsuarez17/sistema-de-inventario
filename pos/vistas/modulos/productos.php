      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
            ...
            </div><!-- ENTRADA FECHA DE VENCIMIENTO -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control input-lg" name="fechavence" min="0" placeholder="Fecha de vencimiento" required>
            ...
            <!-- EDITAR PRODUCTO -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control input-lg" id="editarproducto" name="editarproducto" min="0" required>
