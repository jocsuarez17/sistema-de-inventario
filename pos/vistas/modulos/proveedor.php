            ...
            echo '<tr>
                    ...
                    <td>
                      ...
                      if($_SESSION["perfil"] == "Administrador"){
                          ...
                          echo '<button class="btn btn-danger btnEliminarProveedor" idCliente="'.$value["id"].'"><i class="fa fa-times"></i></button>';
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevaEmpresa" placeholder="Ingresar Proveedor" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoAsesor" placeholder="Ingresar Asesor" required>
      ...
      <?php
        ...
        //Controladorproveedor::crearproveedor();
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarProveedor" id="editarempresa" required>
